...
/****************************************************************************
 * TARGET_HW_PICOFUSION_H20
 ****************************************************************************/

#elif  defined(TARGET_HW_PICOFUSION_H20)
...
# define INTERFACE_USB                  1
# define INTERFACE_USART                1
# define USBDEVICESTRING                "PX4 BL Picofusion H20"
# define USBPRODUCTID                   0x0032
# define BOOT_DELAY_ADDRESS             0x000001a0

# define BOARD_TYPE                     214
// # define BOARD_FLASH_SECTORS            11
// # define BOARD_FLASH_SIZE               (1024 * 1024)
// # define BOARD_FIRST_FLASH_SECTOR_TO_ERASE 2
...
# define BOARD_FLASH_SIZE               (1024 * 1024)
# define APP_RESERVATION_SIZE           (BOARD_FIRST_FLASH_SECTOR_TO_ERASE * 16 * 1024)
